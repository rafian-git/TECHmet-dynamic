...
<head>
    ...
    <link rel="stylesheet" href="public/Site/css/contact.css"/>
    ...
    <div class="inner navigation">
        ...
        <div class="nav-menu">
            ...
            <ul class="nav main-nav">
                ...
                <li class="active"><a class="scroll" href="{{ route('contact') }}">contact</a></li>
            </ul>
...
<section style="font-family: 'Roboto Condensed', sans-serif !important;">
    <div class="container-contact100" style="font-family: 'Roboto Condensed', sans-serif !important;">
        ...
        <div class="wrap-contact100" style="font-family: 'Roboto Condensed', sans-serif !important;margin-top:40px;padding-top:0px;">
            <form class="contact100-form validate-form" action="{{ route('contact.send') }}" method="POST">
                @csrf
            ...
            Get in Touch <i class="fa fa-commenting"></i>
                ...
                <div class="wrap-input100 rs1-wrap-input100 validate-input" data-validate="Subject is required">
                ...
                <div class="wrap-input100 rs1-wrap-input100">
                    ...
                    <input class="input100" type="text" name="location" placeholder="Where you live">
                    <span class="focus-input100"></span>
                </div>
          ...
          For any question contact our 24/7 call center:<a href="tel:+8801973666124"> <span class="contact100-more-highlight">+880 1973-666 124</span></a>
        </span>
        </div>
    </div>
</section>
