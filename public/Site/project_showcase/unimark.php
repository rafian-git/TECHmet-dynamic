...
<section id="home" class="">
    ...
    <section id="main_content">
        ...
        <div class="container">
            ...
            <p>
                A Housing Company static website
            </p>
            <i class="fa fa-globe"><a href="http://unimarkbd.com">www.unimarkbd.com</a> </i>
            ...
            <div class="tz-gallery" style="margin-bottom: 50px; margin-top: 20px;">
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a class="lightbox" href="../images/project_image/unimark/1.png">
                                <img src="../images/project_image/unimark/1.png" alt="Park" class="img-thumbnail card-img-top">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a class="lightbox" href="../images/project_image/unimark/4.png">
                                <img src="../images/project_image/unimark/4.png" alt="Park"class="img-thumbnail card-img-top">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a class="lightbox" href="../images/project_image/unimark/3.png">
                                <img src="../images/project_image/unimark/3.png" alt="Park" class="img-thumbnail card-img-top">
                            </a>
                        </div>
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a class="lightbox" href="../images/project_image/unimark/2.png">
                                <img src="../images/project_image/unimark/2.png" alt="Park" class="img-thumbnail card-img-top">
                            </a>
                        </div>
                    </div>
