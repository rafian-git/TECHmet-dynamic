...
<section id="home" class="">
    ...
    <section id="main_content">
        ...
        <div class="container">
            ...
            <p>
                Bulk selling-buying platform for stocklot traders
            </p>
            <i class="fa fa-globe"><a href="https://garmentbasket.com">garmentbasket.com</a> </i>
            ...
            <div class="tz-gallery" style="margin-bottom: 50px; margin-top: 20px;">
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a class="lightbox" href="../images/project_image/garment_basket/1.png">
                                <img src="../images/project_image/garment_basket/1.png" alt="Park" class="img-thumbnail card-img-top">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a class="lightbox" href="../images/project_image/garment_basket/4.png">
                                <img src="../images/project_image/garment_basket/2.png" alt="Park" class="img-thumbnail card-img-top">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a class="lightbox" href="../images/project_image/garment_basket/3.png">
                                <img src="../images/project_image/garment_basket/3.png" alt="Park" class="img-thumbnail card-img-top">
                            </a>
                        </div>
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <a class="lightbox" href="../images/project_image/garment_basket/2.png">
                                <img src="../images/project_image/garment_basket/4.png" alt="Park"class="img-thumbnail card-img-top">
                            </a>
                        </div>
                    </div>
